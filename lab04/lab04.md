...
### Пролог
Я написал прокси-сервер для проксирования веб-страниц. Используемые библиотеки приложил в requirements.txt. Немалая часть кода взята из предыдущей лабы, так что флаги тут похожие:
```
